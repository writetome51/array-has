...
if (arrayHasAdjacent([true, false, 'xdfhT!@#$%^&*()', [1.05]], arr)) console.log('test 4 passed');
else console.log('test 4 FAILED');


// Test 5: Make sure it can spot slight differences:
arr = [1.05, 10, true, false, 'xdfhT!@#$%^&*()', [1.05555]];
if (arrayHasAdjacent(['xdfhT!@#$%^&*()', [1.0555]], arr)) console.log('test 5 FAILED');
else console.log('test 5 passed');


// Test 6:
arr = [1.05, 10, true, false, 1, 'xdfhT!@#$%^&*()', 1, 2, 2, 'xdfhT!@#$%^&*()', 1, 2];
if (arrayHasAdjacent([1, 2, 'xdfhT!@#$%^&*()'], arr)) console.log('test 6 FAILED');
else console.log('test 6 passed');


// Test 7:
arr = [1.05, 10, true, false, 'xdfhT!@#$%^&*()', 1, 2, 3, 4];
if (arrayHasAdjacent([true], arr)) console.log('test 7 passed');

...
if (arrayContainsArray(arrayToSearchFor, arrayToSearchInside)) console.log('test 1' +
	' passed');
...
arrayToSearchFor = [''];
if (arrayContainsArray(arrayToSearchFor, arrayToSearchInside)) console.log('test 2' +
	' failed');
...
if (arrayContainsArray(arrayToSearchFor, arrayToSearchInside)) console.log('test 3' +
	' passed');
...
if (arrayContainsArray(arrayToSearchFor, arrayToSearchInside)) console.log('test 4' +
	' passed');
...
if (arrayContainsArray(arrayToSearchFor, arrayToSearchInside)) console.log('test 5' +
	' failed');
...
if (arrayContainsArray(arrayToSearchFor, arrayToSearchInside)) console.log('test 6' +
	' passed');
...
arrayToSearchInside = [1, true, '', {}, ['', 1, true, [1, [1, [1, [1]]]], '200'], 'one'];
if (arrayContainsArray(arrayToSearchFor, arrayToSearchInside)) console.log('test 7' +
	' failed');
